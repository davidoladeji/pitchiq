    ...
    <div className="min-h-screen bg-navy-50" aria-busy="true">
      ...
      <main id="main" tabIndex={-1} className="pt-24 pb-16 px-4 sm:px-6 outline-none" aria-label="Main content" aria-hidden="true">
        <div className="max-w-3xl mx-auto space-y-6">
          <div>
            <div className="h-8 w-40 rounded-lg bg-navy-100 animate-pulse motion-reduce:animate-none" />
            <div className="h-4 w-64 mt-2 rounded bg-navy-50 animate-pulse motion-reduce:animate-none" />
          </div>
          <div className="rounded-2xl border border-navy-50 bg-white p-6 space-y-4 animate-pulse motion-reduce:animate-none">
