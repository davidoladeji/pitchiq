      ...
      <main id="main" tabIndex={-1} className="pt-24 pb-16 px-4 sm:px-6 outline-none" aria-label="Main content" aria-hidden="true">
        <div className="max-w-3xl mx-auto space-y-6">
          <div>
            ...
            <div className="h-4 w-72 mt-2 rounded bg-navy-50 animate-pulse" />
          </div>
          <div className="rounded-2xl border border-navy-50 bg-white p-6 space-y-5 animate-pulse">
          ...
          <div className="rounded-2xl border border-navy-50 bg-white p-6 animate-pulse">
