...
export default function DeckReportButton({ shareId }: { shareId: string }) {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-1.5 min-h-[44px] px-3 py-1.5 rounded-lg border border-navy-200 dark:border-white/10 text-xs font-semibold text-navy dark:text-white hover:bg-navy-50 dark:hover:bg-white/5 transition-colors disabled:opacity-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-electric focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-navy-950"
    >
