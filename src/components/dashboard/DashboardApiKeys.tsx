...
export default function DashboardApiKeys({
  ...
  if (!hasApiAccess) {
    return (
      <div className="bg-white dark:bg-navy-900 rounded-2xl border border-navy-200 dark:border-white/10 p-5 sm:p-6">
        ...
        <>
          ...
          <div className="space-y-2" aria-hidden="true">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="flex items-center justify-between gap-3 px-4 py-3 rounded-xl border border-navy-200 dark:border-white/10 bg-white dark:bg-navy-900"
              >
            ...
            <div
              ...
              className={`flex items-center justify-between gap-3 px-4 py-3 rounded-xl border ${
                k.revoked
                  ...
                  : "border-navy-200 dark:border-white/10 bg-white dark:bg-navy-900"
              }`}
            >
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2">
