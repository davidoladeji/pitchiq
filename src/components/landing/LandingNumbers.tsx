...
const STATS: Stat[] = [
  {
    ...
    cardClass: "bg-gradient-to-br from-electric-50 to-violet-50",
  ...
  },
  {
    ...
    cardClass: "bg-gradient-to-br from-amber-50 to-orange-50",
    iconClass: "bg-amber-100 border border-amber-200 text-amber-600",
  },
  {
    value: 8,
    suffix: "",
    ...
    iconClass: "bg-emerald-100 border border-emerald-200 text-emerald-600",
  },
];
